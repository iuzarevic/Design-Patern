...
import org.foi.uzdiz.ivauzarev.dz3.helpers.KorisnikCreator;
import org.foi.uzdiz.ivauzarev.dz3.helpers.UserFactory;
...
//                id, naziv, ukupnoOtpada(), ukupnoStaklo(),ukupnoPapir(),ukupnoBio(),ukupnoMetal(),ukupnoMjesano(),"");
        counterString += "*";
        st.addRow(counterString + id, naziv, Float.toString(ukupnoOtpada()), Float.toString(ukupnoStaklo()), Float.toString(ukupnoPapir()), Float.toString(ukupnoBio()), Float.toString(ukupnoMetal()), Float.toString(ukupnoMjesano()), "");
